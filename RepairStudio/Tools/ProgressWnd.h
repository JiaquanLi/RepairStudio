...
public:
    ...
    CProgressWnd(CWnd* pParent, LPCTSTR pszTitle, BOOL bPos = TRUE, BOOL bSmooth = TRUE, BOOL bHide = FALSE);
    virtual ~CProgressWnd();

    BOOL Create(CWnd* pParent, LPCTSTR pszTitle, BOOL bSmooth = TRUE, BOOL bHide = FALSE);
