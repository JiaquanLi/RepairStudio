...
CProgressWnd::CProgressWnd(CWnd* pParent, LPCTSTR pszTitle, BOOL bPos/*=TRUE*/, BOOL bSmooth /* = TRUE */, BOOL bHide /* = FALSE */)
{
	m_hbrush = NULL;
	m_MostTopFlag = FALSE;
	m_bCenter = bPos;
	...
	Create(pParent, pszTitle, bSmooth, bHide);
}
...
BOOL CProgressWnd::Create(CWnd* pParent, LPCTSTR pszTitle, BOOL bSmooth /* = TRUE */, BOOL bHide /* = FALSE*/)
{
	BOOL bSuccess;
