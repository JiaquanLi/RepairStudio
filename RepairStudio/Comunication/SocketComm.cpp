...
//  int nType: type of socket to create (SOCK_STREAM, SOCK_DGRAM)
///////////////////////////////////////////////////////////////////////////////
bool CSocketComm::ConnectTo(LPCTSTR strDestination, int nServiceName, int nFamily, int nType)
{
	...
	SOCKADDR_IN addrSrv;
	addrSrv.sin_addr.S_un.S_addr=inet_addr(strDestination);//服务器端的地址
	addrSrv.sin_family=AF_INET;
	addrSrv.sin_port=htons(nServiceName);
	...
	m_hComm = (HANDLE) sockClient;
	
    return (INVALID_SOCKET != sockClient);
}
